  ...
  return (
    <GlobalContainer>
      ...
      <FirstSection>
        <FirstContainerFS>
          ...
          <div className="first__container__p">
            <p className="global__p">
              ...
              llegada de la Flora J-350GT, vas a descubrir una solución de alta
              calidad que no solo simplifica los procesos, sino que también te
              ahorra costos y tiempo.
            </p>
            <p className="global__p">
              Impresión sin primer (a diferencia de los sistemas tradicionales),
              tecnología single-pass de última generación y una velocidad de
              hasta 75 metros lineales por minuto hacen que esta prensa digital
              sea la solución más rentable del mercado actual.
            </p>
          </div>
        </FirstContainerFS>
        <SecondContainerFS>
        ...
        <FirstContainerFS>
          <h3 className="first__container__haches">¿Qué es la Flora J350GT?</h3>
          <p className="first__container__p global__p">
            ...
            garantiza impresiones rápidas y precisas, haciendo que cada etiqueta
            salga perfecta a la primera pasada.
          </p>
          <p className="first__container__p global__p">
      ...
      <ThirdSection>
        ...
        <ContainerElegir>
          <div className="container__elegir">
            ...
            <p className="global__p">
              ...
              automáticos que simplifican el proceso, ahorrando tiempo y trabajo
              manual.
            </p>
          </div>
          <div className="container__elegir">
        ...
        <ContainerElegir>
          ...
          <div className="container__elegir">
            ...
            <p className="global__p">
              Con un sistema que optimiza el manejo de bobinas, la Flora J-350GT
              reduce el tiempo de carga, minimiza desperdicios y mejora la
              productividad en cada producción.
            </p>
          </div>
        </ContainerElegir>
      </ThirdSection>
      ...
      <FourthContainer>
        ...
        <FirstContainerDiferencia>
          <FirstContainerDiferenciaInfo>
            <h4>Tecnología</h4>
            <p className="global__p">
              Estas impresoras utilizan diminutas gotas de tinta líquida que son
              proyectadas directamente sobre el material a través de boquillas
              (nozzles).
            </p>
          </FirstContainerDiferenciaInfo>
          <FirstContainerDiferenciaInfo>
            ...
            <p className="global__p">
              ...
              material, lo que permite imprimir sobre superficies texturadas sin
              problemas.
            </p>
          </FirstContainerDiferenciaInfo>
          <FirstContainerDiferenciaInfo>
        ...
        <FirstContainerDiferencia>
          ...
          <FirstContainerDiferenciaInfo>
            ...
            <p className="global__p">
              Las HP Indigo están diseñadas para funcionar mejor en superficies
              lisas o con un nivel muy bajo de textura, ya que dependen de una
              transferencia más controlada de la tinta al material.
            </p>
          </FirstContainerDiferenciaInfo>
        </FirstContainerDiferencia>
        ...
        <FirstContainerDiferencia>
          <FirstContainerDiferenciaInfo>
            <h4>Tecnología</h4>
            <p className="global__p">
              Las impresoras de tóner funcionan con un polvo que se funde sobre
              la superficie del material mediante calor. El tóner no se absorbe
              en el material, sino que se adhiere a su superficie.
            </p>
          </FirstContainerDiferenciaInfo>
          <FirstContainerDiferenciaInfo>
            <h4>Limitaciones</h4>
            <p className="global__p">
              ...
              texturados, el tóner puede no adherirse bien o de manera uniforme,
              provocando problemas de calidad en la impresión.
            </p>
          </FirstContainerDiferenciaInfo>
          <FirstContainerDiferenciaInfo>
            <h4>Compatibilidad del Material</h4>
            <p className="global__p">
              Las impresoras de tóner funcionan mejor en superficies lisas y sin
              porosidad, ya que el polvo de tóner no se absorbe en el material.
              En sustratos con textura o rugosidad, la adherencia puede verse
              afectada, reduciendo la calidad de impresión.
            </p>
          </FirstContainerDiferenciaInfo>
        </FirstContainerDiferencia>
      </FourthContainer>
