...
export const FloraSwift = ({ heroImage, title }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Flora Swift - Daniel Moras</title>
        <meta
          name="description"
          content="Impresión rotativa inkjet digital monocromática para editorial con tecnología multi-pass y single-pass impresión para volúmenes grandes"
        />
        <link rel="canonical" href="https://danielmoras.com.ar/flora-swift" />
      </Helmet>
      <GlobalContainer>
        ...
        <FirstSection>
          <FirstContainerFS>
            <div className="first__container__haches">
              <h3 className="first__hache__t">
                PRESENTAMOS EL FUTURO EDITORIAL
              </h3>
            ...
            <div className="first__container__p">
              ...
              <p className="global__p">
                Con tecnología inkjet digital single-pass, este equipo
                revoluciona la manera de imprimir. No importa el tamaño de la
                producción, la Flora Swift440 te garantiza una calidad de
                impresión excepcional y costos súper competitivos.
              </p>
            </div>
          </FirstContainerFS>
          <SecondContainerFS>
          ...
          <FirstContainerFS>
            ...
            <p className="first__container__p global__p">
              ...
              por minuto con una precisión asombrosa, garantizando que cada
              página salga perfecta en la primera pasada.
            </p>
        ...
        <ThirdSection>
          <ContainerElegir>
            ...
            <div className="container__elegir">
              <h4>Rentabilidad</h4>
              <p className="global__p">
                En comparación con otros sistemas, la Flora Swift440 es la
                opción más rentable, optimizando los costos de producción y
                reduciendo tiempos de ajuste y mantenimiento.
              </p>
            </div>
          </ContainerElegir>
          <BtnA
          ...
          <ContainerElegir>
            <div className="container__elegir">
              ...
              <p className="global__p">
                ...
                grandes volúmenes en menos tiempo y con menos desperdicio de
                papel y tinta. ¡Hasta 140 metros lineales por minuto!
              </p>
            </div>
            <div className="container__elegir">
              ...
              <p className="global__p">
                ...
                requieran la más alta calidad, como libros y revistas en blanco
                y negro.
              </p>
            </div>
          </ContainerElegir>
        ...
        <ContainerCita>
          <h3 className="first__hache__t">
            ¡Conocé la Flora Swift440 en Vivo!
          </h3>
          <p className="global__p">
