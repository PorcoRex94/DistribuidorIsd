        ...
        <FirstSection>
          <FirstContainerFS>
            ...
            <div className="first__container__p">
              <p className="global__p">
                El mundo de la impresión editorial está cambiando, y con la
                Flora Phenix440, podés ser parte de esa transformación. Esta
                rotativa inkjet digital marca el inicio de una nueva era, en la
                que la tecnología, la rapidez y la rentabilidad se combinan para
                crear resultados excepcionales.
              </p>
              <p className="global__p">
                ¿Libros, revistas u otras publicaciones a color? Con la
                Phenix440, cada proyecto es una oportunidad para innovar,
                simplificar y optimizar tu proceso de producción. Más rápida,
                eficiente y rentable que los sistemas tradicionales, esta
                rotativa está diseñada para que las editoriales puedan dar su
                próximo gran salto hacia el futuro.
              </p>
            </div>
          </FirstContainerFS>
          <SecondContainerFS>
          ...
          <FirstContainerFS>
            ...
            <p className="first__container__p global__p">
              La Flora Phenix440 es una rotativa digital inkjet de alta
              velocidad, creada para revolucionar la impresión editorial. Con
              tecnología single-pass, imprime cada página en una sola pasada,
              garantizando precisión, calidad y velocidad sin precedentes. Ya no
              es necesario elegir entre tiradas grandes o pequeñas, esta
              increíble solución se adapta a cualquier tipo de proyecto con la
              misma excelencia.
            </p>
            <p className="first__container__p global__p">
          ...
          <HorizonteContainer>
            <ContainerContainerHorizonte>
              ...
              <p className="global__p">
                ...
                impresoras de tóner o tecnologías lentas y costosas. Su enfoque
                es más ágil y flexible, permitiendo que cada trabajo sea rápido
                y rentable, sin comprometer la calidad.
              </p>
            </ContainerContainerHorizonte>
          </HorizonteContainer>
        </FirstSection>
        ...
        <ThirdSection>
          ...
          <ContainerElegir>
            <div className="container__elegir">
              ...
              <p className="global__p">
                La impresión inkjet digital no genera fricción con el material,
                lo que asegura que cada página salga perfecta y sin desgaste.
              </p>
            </div>
            <div className="container__elegir">
          ...
          <ContainerElegir>
            ...
            <div className="container__elegir">
              ...
              <p className="global__p">
                ...
                imágenes y textos nítidos, perfectos para ediciones que
                requieran la más alta calidad.
              </p>
            </div>
          </ContainerElegir>
        </ThirdSection>
